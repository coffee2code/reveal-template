...
if ( ! class_exists( 'c2c_RevealTemplate_Plugin_041' ) ) :

abstract class c2c_RevealTemplate_Plugin_041 {
...
//				echo '<div class="hr">&nbsp;</div>' . "\n";
	...
	public function options_page() {
		...
		$c2c = '<a href="http://coffee2code.com" title="coffee2code.com">' . __( 'Scott Reilly, aka coffee2code', 'reveal-template' ) . '</a>';
		echo sprintf( __( 'This plugin brought to you by %s.', 'reveal-template' ), $c2c );
		echo '<span><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6ARCFJ9TX3522" title="' . esc_attr__( 'Please consider a donation', 'reveal-template' ) . '">' .
		__( 'Did you find this plugin useful?', 'reveal-template' ) . '</a></span>';
		echo '</div>' . "\n";
